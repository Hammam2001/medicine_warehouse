  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text('Orders' , style: TextStyle(color: Colors.white ,fontSize: 20 , fontWeight: FontWeight.w400 ),),
      ),
      body: SafeArea(
        child: FutureBuilder(
          ...
          builder: (context, snapshot) {
            ...
            return Container(
              ...
              child: Column(
                children: [
                  Container(padding: const EdgeInsets.all(10),alignment: Alignment.topRight,child: Text('the price is : ${ddd['full_price']} S.P',style: TextStyle(color: Theme.of(context).primaryColor , fontSize: 18 , fontWeight: FontWeight.bold),)) ,
                  ListView.builder(
